    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{('public/backend/images/anh.jpg')}}">
                <span class="username">
                	<?php
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			   <img alt="" src="{{('public/backend/images/slide.jpg')}}"  width="1230" height="200">
			</div>
		  </div>
  <!-- / footer -->
</section>
...
<script src="https://canvasjs.com/assets/script/jquery.canvasjs.min.js"></script>
  ...
  $( function() {
    $("#datepicker").datepicker({
        ...
        nextText:"Thang sau",
        dateFormat:"yy-mm-dd",
        dayNamesMin:["Thu 2","Thu 3","Thu 4","Thu 5","thu 6","Thu  7","Chu nhat"],
        duration:"slow"
    });
